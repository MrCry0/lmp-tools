...
Note that Nixu uses the 33MHz clock therefore update xlwp_tool.csh to
xlwp_tool_nixu.sh

jramirez@trex lwip (master)$ cat xlwp_tool_nixu.sh
#!/bin/bash
...
jramirez@trex nixu.1$ cat 1.run.2019.sh
...
docker run --privileged -ti --rm \
       ...
       -v /home/jramirez/Foundries/projects/nixu.1/deploy,nixu-base:/home/vivado/deploy,nixu-base \
       -v /home/jramirez/Foundries/projects/nixu.1/deploy,nixu-base/lwip:/home/vivado/xlwp \
       -v /home/jramirez/Foundries/projects/nixu.1/deploy,nixu:/home/vivado/deploy,nixu \
...
line
 ...
 2) program_flash:
    ...
    To program boot.bin (ie, for NIXU)
